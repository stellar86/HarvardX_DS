...
author: "Estelle Rossouw (https://github.com/stellar86/HarvardX_DS)"
...
The RMSE for this model was 1.0583, which requires improvement as this does not meet the baseline RMSE requirement of  0.8649.
\newpage
**Movie-Effect Model**
...
```
The RMSE for this model was 0.9488, which requires improvement as this does not meet the baseline RMSE requirement of  0.8649.
\newpage
...
```
The RMSE for this model was 0.8723, which requires improvement as this is not meeting the baseline RMSE requirement of  0.8649.
\newpage
...
```
The RMSE for this model was 0.872, which requires improvement as this does not meet the baseline RMSE requirement of  0.8649.
\newpage
...
```
From the regularization results, the model that took into account both movie+user+genre+year effects yielded to lowest RMSE results of 0.87 with a lambda value of 3.5. This model will be tested on the validation set for final results.

\newpage
**Testing optimized model on validation set**

When testing the optimized model on the validation set, the RMSE is 0.8647 which exceeds the baseline RMSE requirement of 0.8649.
```{r,echo=TRUE}
...
```
When testing the SGD Model on the validation set, the RMSE is 0.783 which exceeds the baseline RMSE requirement of  0.8649.
...
From hours of testing different models and configurations, it was clear from research that matrix factorization model offers superior performance when applied to recommender systems (as seen in the RMSE results). When implemented on the supplied validation dataset, an RMSE of 0.783 was obtained. 
